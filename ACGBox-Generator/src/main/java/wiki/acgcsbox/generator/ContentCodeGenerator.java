...
public class ContentCodeGenerator {
    ...
    // 数据库密码
    private static final String DATA_SOURCE_PASSWORD = "Krian18723220402";
...
//			"mq_message_history"
    ...
    public static void main(String[] args) {
        ...
        //生成路径
        gc.setOutputDir(System.getProperty("user.dir") + "/CSBox Generator/src/main/java");
        gc.setAuthor("Krian");
        gc.setOpen(false);
        ...
        dsc.setUrl("jdbc:mysql://82.157.192.119:3306/csbox-vedio-" + SERVICE_NAME

package wiki.acgcsbox.generator.website;
 ...
 * @author Krian
 * @version 1.0
 * @description: WebSite MyBatisPlus 代码生成器
 * @date 2023/4/3 0003 13:55
 */
public class SiteGenerator {

    // TODO 修改服务名以及数据表名
    private static final String SERVICE_NAME = "acg_box_website";  // 数据名
    private static final String DATA_SOURCE_USER_NAME = "root";
    private static final String DATA_SOURCE_PASSWORD = "Kuang8223004369";

    private static final String[] TABLE_NAMES = new String[]{  // 数据表名
            "acgbox_website_site",
            "acgbox_website_menu",
    };
    ...
    public static void main(String[] args) {
        ...
        pc.setParent("wiki.acgcsbox." + SERVICE_NAME);
